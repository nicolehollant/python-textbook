...
\noindent{\LARGE Do I have Python?}\\
...
\noindent{\large A quick aside for setting up your environment:}\\
...
\noindent{\large Back to business:}\\
...
\noindent{\LARGE Command Line Python}\\
...
\noindent{\LARGE Python from a file!}\\
...
\noindent{\large An aside on using your terminal}\\
...
\noindent{\Large General Variables}\\
...
\noindent{\LARGE Practical Example!}\\
...
\noindent{\LARGE Object Oriented Programming}\\
...
\noindent{\Large Basic Class Example: Triangle}\\
...
\noindent{\Large Encapsulation / Getters example: Banks}\\
...
\noindent{\Large Encapsulation / Getters and Setters example: Clock}\\
...
\noindent{\Large Operator Overloading / Magic Methods: Fractions}\\
...
\noindent{\Large Inheritance and Polymorphism}\\
...
\noindent{\LARGE File Manipulation}\\
...
\noindent{\Large Working with CSV}\\
...
\noindent{\LARGE Bye for now (and only for now)}\\
